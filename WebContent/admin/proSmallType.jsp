	...
	$('#tianjia').click(function(){
	 ...
	 //每页显示数目
	  $('#selects').change(function(){
	    	 ...
	    	 if(selects==1){
	    		 window.location.href="promt_all.action?prePage=10";
	    	 }
	    	 if(selects==2){
	    		 window.location.href="promt_all.action?prePage=20";
	    	 }
	    	 if(selects==3){
	    		 window.location.href="promt_all.action?prePage=30";
	    	 }
	    	 if(selects==4){
	    		 window.location.href="promt_all.action?prePage=40";
	    	 }
	     });
...
<body>
<div class="tag">
 <form action="promt_all.action" method="post" id="form1">
    <table >
      <tr>
          <td>留言者：</td>
          <td>
...
<div class="tag2">
<div class="demo">
      <s:if test="#request.admin_proSmallTypes==null || #request.admin_proSmallTypes.size()==0">
                              没有商品信息！
      </s:if>
      <s:else>
          <table border="1" cellpadding="10" cellspacing="0" class="bordered">
              ...
              <s:iterator value="#request.admin_proSmallTypes">
              <tr>
                  <td>${id }</td>
                  <td>${proName }</td>
                  <td>${productType.proName }</td>
                  <td>${remarks }</td>
                  <td class="button">
                     <a href="promt_edit.action?id=${id }">Edit</a>
                  </td>
                  <td class="button">
 ...
 <div class="doo">
   <div class="do">
	   ...
	   <a href="promt_all.action?page=${pageBeans.firstPage }"> &lt;&lt; </a>
	   <a href="promt_all.action?page=${pageBeans.previousPage }">上一页</a>
	   <a href="promt_all.action?page=${pageBeans.nextPage }">下一页</a>
	   <a href="promt_all.action?page=${pageBeans.lastPage }"> &gt;&gt; </a>
